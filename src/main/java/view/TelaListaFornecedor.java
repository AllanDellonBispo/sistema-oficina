...
public class TelaListaFornecedor extends javax.swing.JFrame {
    ...
    public TelaListaFornecedor() throws ClassNotFoundException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1350, 520));
        setResizable(false);
    ...
    public void lerTabela(){
       ...
       FornecedorController f = new FornecedorController();
            ...
            for(int i = 0; i < f.mostrarTodos().size(); i++){
            
                    modelo.addRow(new Object[]{
                    
                       f.mostrarTodos().get(i).getId(),
                       f.mostrarTodos().get(i).getNome(),
                       f.mostrarTodos().get(i).getCnpj(),
                       f.mostrarTodos().get(i).getEndereco(),
                       f.mostrarTodos().get(i).getTelefone(),
                    });
            }
    }
...
//    
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        fornecedorController.remover(Integer.parseInt(CampoId.getValue().toString()));
        lerTabela();
